...
public class SaveBlogSerializado {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        BlogSerializado blogserializado = new BlogSerializado();
        blogserializado.setUrl("www.facebook.com");
        blogserializado.setCategoria("Redes Sociais");
        blogserializado.setDescricao("facebook");
